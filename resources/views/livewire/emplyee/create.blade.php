<div>
    <div class="row">
        <div class="col-12">
            @if ($status == 1)
                @include('livewire.emplyee.index')
            @endif
        </div>
    </div>
    @if ($status == 2)
        ...
        <div class="col-12">
            ...
            @if ($curent == 3)
                <div>
                    ...
                    <br>
                    <div class="row">
                        <label style="color: red">upload file</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <button class="btn btn-primary" type="button" wire:click="submit">Save</button>
                        </div>
                    </div>
                </div>
            @endif
